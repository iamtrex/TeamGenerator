...
from data import Players as P
from data import Synergy as S
"""
Constants for data.
"""
...
Rex = P.Player("Rex", [1, 3, 3, 3, 2], [R.LGo, R.MPl, R.HGo, R.LPl, R.HGo], [5, 3, 2, 4])
...
Josh = P.Player("Josh", [1, 2, 3, 3, 3], [R.MGo, R.MGo, R.HGo, R.MPl, R.LPl], [3, 4, 2, 3.5])
